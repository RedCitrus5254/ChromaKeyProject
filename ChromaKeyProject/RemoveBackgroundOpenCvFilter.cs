	...
	public class RemoveBackgroundOpenCvFilter : OpenCvFilter
	{
		...
		private Mat GetGradient(Mat src)
		{
			using (var preparedSrc = new Mat())
			{
				...
				preparedSrc.SaveImage("out1.jpg");
